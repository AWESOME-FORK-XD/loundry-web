...
<div id='divBroadcastPesan'>
    ...
    <div id='divFormTambahBroadcast' class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id='txtJudul' placeholder="Masukkan Judul Pesan">
            </div>
            <div class="form-group">
                ...
                <ul>
                    ...
                    <li>Cth : "Assalamu' allaikum Pelanggan (Nama Laundry), kita lagi ada promo untuk memperkenalkan sistem baru kita, masukkan kode promo berikut ini (KMZWAY87AA)" </li>
                </ul>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
    ...
    <div id='divStatusBroadcast'>
        <h5>Sedang mengirimkan pesan broadcast, tunggu sampai proses selesai</h5>
    </div>
</div>
</div>
