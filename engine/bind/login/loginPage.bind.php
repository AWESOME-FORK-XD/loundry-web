...
<body style="font-family: 'Nunito', sans-serif;">
    <div class="container-scroller">
        <div class="container-fluid page-body-wrapper full-page-wrapper">
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left py-5 px-4 px-sm-5" id='login-app'>
                                <div class="brand-logo" style='text-align:center;'>
                                    <img src="<?=STYLEBASE; ?>/login/images/logo_laundry.jpg" alt="logo"
                                        style='width:200px; '>
                                    <h4 style="font-weight:bold;">Aplikasi Manajemen Laundry</h4>
                                </div>
                                <div style='text-align:center;'>
                                    <h6 class="font-weight-light">Masukkan Username dan Password anda di bawah ini untuk melanjutkan.</h6>
                                    <div>
                                        <div class="pt-3">
                                            ...
                                            <div class="mt-2">
                                                <div style='padding-top:12px;'>
                                                    <h5 class="font-weight-light">2023 &copy; <a href='https://instagram.com/jud_oiiit'
                                                            target=''>KDM&A Dev</a></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <script>
                const server = "http://localhost/laundry/";
            </script>
